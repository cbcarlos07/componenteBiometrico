...
namespace Captura.Api.Controllers
{
    ...
    public class CapturaController : ApiController
    {
        ...
        [HttpPost]
        //[Route("identify/{url:string}")]
        [Route("Identify")]
        public dynamic Identify(HttpRequestMessage request) 
        {

            
            string  body = request.Content.ReadAsStringAsync().Result;
            dynamic json = JsonConvert.DeserializeObject(body);
            dynamic obj = buscar( json );
            return  obj;
        }
        ...
        private string decodedBase64(string encodedText, Encoding encoding = null)
        {
